...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Sign in to NutriAI to access your personalized AI health coach." },
            ...
            <TabsContent value="signup" className="mt-6">
              <form onSubmit={handleSignUp} className="space-y-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <Input id="password-up" type="password" autoComplete="new-password" required minLength={6} value={password} onChange={(e) => setPassword(e.target.value)} />
