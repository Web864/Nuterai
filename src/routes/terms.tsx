      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 space-y-6 text-muted-foreground">
          <section>
            ...
            <p className="mt-2">
              NutriAI provides general wellness information based on the data you enter. It is not medical advice, diagnosis, or treatment.
          ...
          <section>
            ...
            <p className="mt-2">
              Don't use NutriAI to harass others, misuse the AI features, or attempt to disrupt the service.
            </p>
          </section>
          <section>
