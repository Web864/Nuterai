...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "How NutriAI collects, uses, and protects your health data.",
      },
    ],
  }),
      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
        ...
        <div className="mt-10 space-y-6 text-muted-foreground">
          <section>
            ...
            <p className="mt-2">
              To personalize your plan, NutriAI collects the information you provide during
              onboarding (age, height, weight, dietary preferences, activity level, goals) and any
              data you choose to log (meals, workouts, water, sleep, mood, weight).
            </p>
          </section>
          <section>
            <h2 className="font-display text-2xl text-foreground">How we use it</h2>
            <p className="mt-2">
              We use your data solely to generate your personalized plan, adapt it over time, and
              show your progress. We do not sell your data.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p className="mt-2">
              When you use AI features, prompts and relevant context are sent to trusted AI
              providers for processing. Providers are contractually prohibited from training on your
              data.
            </p>
          </section>
          <section>
