  ...
  public: {
    Tables: {
      ...
      ai_content_feedback: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_content_feedback_coach_message_id_fkey";
      ...
      notifications: {
        ...
        Relationships: [
          {
            foreignKeyName: "notifications_reminder_event_id_fkey";
            columns: ["reminder_event_id"];
            isOneToOne: false;
      ...
      reminders: {
        Row: {
          created_at: string;
          created_by: Database["public"]["Enums"]["reminder_creator"];
          days_of_week: number[];
          enabled: boolean;
          id: string;
          is_active: boolean;
      ...
      user_goals: {
        Row: {
          ...
          workout_experience: Database["public"]["Enums"]["workout_experience"] | null;
        };
        Insert: {
          activity_level?: Database["public"]["Enums"]["activity_level"] | null;
          age?: number | null;
    ...
    Functions: {
      ...
      check_ai_rate_limit: { Args: { p_endpoint: string }; Returns: Json };
      ensure_user_stats: {
    ...
    Enums: {
      ...
      meal_source: "manual" | "ai_text" | "ai_photo" | "favorite" | "ai_photo_scan" | "barcode";
      meal_type: "breakfast" | "lunch" | "dinner" | "snack";
      notification_action: "pending" | "completed" | "snoozed" | "dismissed" | "missed";
      post_visibility: "public" | "friends" | "private";
      reminder_creator: "user" | "system" | "ai_coach";
      reminder_event_type:
        "triggered" | "completed" | "snoozed" | "skipped" | "deleted" | "rescheduled" | "started";
      reminder_source:
        "manual" | "diet_plan" | "water_plan" | "ai_coach" | "system" | "workout_plan";
      reminder_type:
        | "meal"
        | "workout"
        | "water"
      ...
      streak_kind: "workout" | "nutrition" | "water" | "login" | "coach" | "reminder";
...
export const Constants = {
  public: {
    Enums: {
      ...
      reminder_source: ["manual", "diet_plan", "water_plan", "ai_coach", "system", "workout_plan"],
      reminder_type: [
        "meal",
        "workout",
        "water",
